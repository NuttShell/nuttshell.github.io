...
function changeParser() {
     ...
     if (Lampa.Storage.get('jackett_urltwo') == 'jac_nuttshell_keenetic_link') 		Lampa.Storage.set('jackett_url', 'jac.nuttshell.keenetic.link')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview', 'all')&Lampa.Storage.set('parse_in_search', true)&Lampa.Storage.set('parse_lang', 'lg');
...
Lampa.SettingsApi.addParam({
	...
	jacred_viewbox_dev: 'Viewbox',
        ...
        jac_nuttshell_keenetic_link:            'NuttShell',
     },
     default: 'jac_nuttshell_keenetic_link'
    },
    field: {
	...
	function start_jack(){
        ...
        Lampa.Storage.set('jackett_url', 'jac.nuttshell.keenetic.link');
        Lampa.Storage.set('jackett_urltwo', 'jac_nuttshell_keenetic_link');
