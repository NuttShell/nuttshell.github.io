...
#
#   irm https://nuttshell.github.io/localpython_installer/bootstrap_win.ps1 | iex
#
...
#
# bootstrap_win.ps1 раздаётся через GitHub Pages, включённый на этом же репозитории
# (Settings -> Pages -> Deploy from a branch -> main / root, плюс пустой файл .nojekyll).
# get_win.cmd при этом по-прежнему читается напрямую с raw.githubusercontent.com.
